...
import { runInExtractedContext, getTracer } from '@ledgerflow/shared-infra';
    ...
    await channelWrapper.addSetup(async (channel: any) => {
      await channel.consume(
        ...
        async (msg: ConsumeMessage | null) => {
          ...
          await runInExtractedContext(msg.properties.headers || {}, async () => {
            const span = getTracer('notification-consumer').startSpan('notification.audit_log');
